...
import Images from "/src/components/projects/jpeg-degrader/Images.astro";
...
{/* <video controls autoplay id="video">
  <source
    src="https://markmiro-website-content.s3.amazonaws.com/projects/degraded/vid.webm"
    type="video/webm"
  />
</video> */}
...
Scroll down to the [solution](#solution) to see how I got these results.
...
![]({s3File('projects/jpeg-degrader/crush.jpeg')})

![]({s3File('projects/jpeg-degrader/crush-2.jpeg')})
...
![]({s3File('projects/jpeg-degrader/results/ezgif-5-ca0acd317f.gif')})
