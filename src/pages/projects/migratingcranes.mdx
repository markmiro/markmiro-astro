...
<div class="not-prose aspect-w-2 aspect-h-1">
  <img
    class="border border-gray-500 rounded-lg"
    src="/figma-export/project-migratingcranes-1x.png"
    srcset="/figma-export/project-migratingcranes-2x.png 2x"
  />
</div>
...
![](/projects/migratingcranes/lighthouse-score-home.png)

The reports are close behind:

![](/projects/migratingcranes/lighthouse-score-report.png)
